...
export default function TeamSlide({eachPeople}) {
    ...
    <>
      <div className="slide wow animate__animated a-button" onClick={openModal}>
        <Image
          ...
          width={eachPeople.image.width}
          height={eachPeople.image.height}
        />
            ...
            <div className="modal-header">
              <button onClick={closeModal} type="button" className="btn btn-link" data-bs-dismiss="modal" aria-label="Close">
                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M10.1396 10L29.8605 30.2753" stroke="#464A4D" strokeWidth="3" strokeLinecap="round"/>
                  <path d="M10 30L30 10" stroke="#464A4D" strokeWidth="3" strokeLinecap="round"/>
                </svg>
              </button>
            </div>
