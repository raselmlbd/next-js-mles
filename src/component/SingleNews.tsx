import { NewsQuery } from "@/datalayer/Types/AllTypes";
...
export default function SingleNews({
  mlesNewsData: { heading, date, description, thumbnail, link },
}: SingleNewsProps): JSX.Element {
  return (
      ...
      <div className="ml-container latest-news-container">
        ...
        <div className="latest-news-body">
          ...
          <div className="text-section">
            <h5>{date}</h5>
            <h3 className="wow animate__animated">{heading}</h3>
