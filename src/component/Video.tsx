import { MeetOurPeople } from "@/datalayer/Types/AllTypes";
...
export default function Video({
  meetOurPeopleData: { heading, description, link, youtubeVideo },
}: VideoProps): JSX.Element {
  const { pathname } = useRouter();
  return (
    <section
      className={`wow meet-people ${pathname === "/careers" && `careerTop`}`}
    >
