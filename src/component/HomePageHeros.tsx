        ...
        <div className="ml-container hero-one-content">
          <div className="text-section">
            <h2
              ...
              dangerouslySetInnerHTML={{ __html: herosData[0].title }}
            ></h2>
            <p
              className="wow animate__animated"
              dangerouslySetInnerHTML={{ __html: herosData[0].description }}
            ></p>
          </div>
      ...
      <section className="wow animate__animated hero-two">
        ...
        <div className="hero-two-content">
          ...
          <div className="text-section">
            <h2
              className="wow animate__animated"
              dangerouslySetInnerHTML={{ __html: herosData[1].title }}
            ></h2>
            <p
              className="wow animate__animated"
              dangerouslySetInnerHTML={{ __html: herosData[1].description }}
            ></p>
          </div>
        </div>
      </section>
      ...
      <section className="wow hero-three">
        ...
        <div className="ml-container hero-three-content">
          <div className="text-section">
            <h2
              className="wow animate__animated"
              dangerouslySetInnerHTML={{ __html: herosData[2].title }}
            ></h2>
            <p
              className="wow animate__animated"
              dangerouslySetInnerHTML={{ __html: herosData[2].description }}
            ></p>
          </div>
          <div className="image-section wow animate__animated">
            <Image
